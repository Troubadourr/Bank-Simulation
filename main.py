...
def doviz_penceresi(kullanici, refresh=None):
    ...
    pencere.iconbitmap(r"assets/b_abc_bank_logo.ico")
...
def kaydet_hesap():
    ...
    # ✅ 7 haneli ID kontrolü
    if not kullanici.isdigit() or len(kullanici) != 7:
        messagebox.showerror("Hata", "Kullanıcı ID 7 haneli ve sadece rakamlardan oluşmalıdır.")
        return
...
def banka_ekrani(kullanici):
    ...
    try:
        logo_path = r"assets/c_abc_bank_logo.png"
...
root.iconbitmap(r"assets/b_abc_bank_logo.ico")
